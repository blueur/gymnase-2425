...
const config: Config = {
  ...
  url: "https://gymnase-2425.davidtang.ch",
  baseUrl: "/",
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://www.instagram.com/blueur.ch/",
          position: "right",
