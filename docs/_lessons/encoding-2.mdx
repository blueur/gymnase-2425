...
- Sauvegarder le fichier [gif.pgm](pathname:///tp/encodage/gif.pgm) dans le dossier `encodage`. Il a le contenu suivant :
  ```txt title="gif.pgm"
  P2
  11 5
  3
...
![](/tp/encodage/mario.png)
![](/tp/encodage/link.png)
![](/tp/encodage/kirby.png)
![](/tp/encodage/peach.png)
![](/tp/encodage/pikachu.png)
![](/tp/encodage/pacman.png)
